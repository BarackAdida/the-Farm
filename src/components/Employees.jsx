...
function Employees() {
    ...
    const fetchEmployees = async () => {
        try {
            const response = await fetch("https://the-farm-backend.onrender.com");
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch("https://the-farm-backend.onrender.com/employeedata", {
                method: "POST",
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await fetch("https://the-farm-backend.onrender.com/employeeinfo", {
                method: "PATCH",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(formData),
            });
